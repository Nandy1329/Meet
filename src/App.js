...
const App = () => {
  ...
  const onNumberOfEventsChange = (number) => {
  ...
  return (
    <div className="App">
      <header className="logo">
        <img src="/meet_logo_app.png" alt="Meet app logo" />
        <h1> meet!</h1>
      </header>
      <div className="search-bars">
        ...
        <NumberOfEvents
          ...
          onNumberOfEventsChange={onNumberOfEventsChange} // Pass the function as a prop
        />
      </div>
